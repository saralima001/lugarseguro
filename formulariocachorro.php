      <label>
         ...
         <form method="post" action="formulariocachorroenviar.php">  
         <div class="flex-container">
            <?php
               if (isset($_POST['nomePet'])) {
                        ...
                        if ($nomePet == 'Gabriel') {
                            echo '<input type="hidden" name="nomePet" id="nomePet" value="Gabriel"/>';
            ...
            <div class="flex-item-left"> <label for="p4">Existem rotas de fuga?</label> </div>
            <div class="flex-item-right"> <textarea rows="2" name="p4" id="p4" required></textarea> </div>

            <div class="flex-item-left"> <label for="p5">Quais motivos te levariam a não poder mais cuidar dele? O que faria com o pet?</label> </div>
            ...
            <div class="flex-item-left"> <label for="p17">Pets podem viver 15 anos ou mais, você está preparado para este compromisso?</label> </div>
            <div class="flex-item-right"> <textarea rows="2" name="p17" id="p17" required></textarea> </div>

            <div class="flex-item-left"> <label for="p18">Observações Adicionais</label> </div>
            <div class="flex-item-right"> <textarea rows="2" name="p18" id="p18"></textarea> </div>
